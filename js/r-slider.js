    ...
    var a = {
        ...
        render: function () {
            ...
            if (this.state.changable !== false) {
                this.eventHandler(".r-slider-button", "mousedown", this.mousedown);
                this.eventHandler(".r-slider-space", "mousedown", this.mousedown);
                this.eventHandler(".r-slider-label", "mousedown", this.labelmousedown);
            }
        },
        ...
        getValueByClick: function (e) {
            ...
            if (this.state.vertical) {
                if (this.state.reverse) {
                    var distance = inner.offset().top + this.height - e.clientY - pageYOffset;
                } else {
                    var distance = e.clientY + pageYOffset - inner.offset().top;
                }
            } else {
                if (this.state.reverse) {
                    var distance = inner.offset().left + this.width - e.clientX - pageXOffset;
                } else {
                    var distance = e.clientX + pageXOffset - inner.offset().left;
                }
            }
